...
?>
    ...
    <head>
        ...
        <script src="nutrients_calc/nutiCtrl.js"></script>
        ...
        <header>
            ...
            <div class="navbar navbar-default navbar-static-top">
                <div class="navbar-header">
                    <a href="rin.php"><img class="logo_class" src="images/logo.jpg" alt="logo" />
                ...
                <ul class="nav navbar-nav">
                    ...
                    <li><a ui-sref="nutri">Nutrients Deficiency</a></li>
